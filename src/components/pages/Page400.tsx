    ...
    <main className='flex flex-col items-center gap-8'>
      <div className='max-w-lg space-y-3 text-center'>
        ...
        <Typography variant='base'>
          It seems we're experiencing some technical difficulties. Not to worry, our team is working on it. In the
          meantime, try refreshing the page or visiting us a bit later.
        </Typography>
      </div>
